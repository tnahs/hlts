...
DEFAULT_APP_DOMAIN_URL=$APP_DOMAIN_URL
DEFAULT_APP_SUBDOMAIN_NAME="www"

DEFAULT_LOGGING_MAIL_SERVER=$LOGGING_MAIL_SERVER
DEFAULT_LOGGING_MAIL_USERNAME=$LOGGING_MAIL_USERNAME
DEFAULT_LOGGING_MAIL_PASSWORD=$LOGGING_MAIL_PASSWORD
DEFAULT_LOGGING_MAIL_PORT=$LOGGING_MAIL_PORT
DEFAULT_LOGGING_MAIL_USE_TLS=$LOGGING_MAIL_USE_TLS

DEFAULT_MAIL_SERVER=$MAIL_SERVER
DEFAULT_MAIL_USERNAME=$MAIL_USERNAME
DEFAULT_MAIL_PASSWORD=$MAIL_PASSWORD
DEFAULT_MAIL_PORT=$MAIL_PORT
DEFAULT_MAIL_USE_TLS=$MAIL_USE_TLS
DEFAULT_MAIL_USE_SSL=$MAIL_USE_SSL
